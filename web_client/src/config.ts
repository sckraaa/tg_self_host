...
export const PRODUCTION_HOSTNAME = process.env.APP_HOSTNAME || 'localhost';
export const PRODUCTION_URL = process.env.BASE_URL || 'http://localhost:1234';
export const WEB_VERSION_BASE = process.env.BASE_URL || '/';
...
export const TME_LINK_PREFIX = process.env.APP_TME_LINK_PREFIX || 'https://t.me/';
...
export const TME_WEB_DOMAINS = new Set([
  ...
  `web.${process.env.APP_HOSTNAME || 'localhost'}`,
  `a.${process.env.APP_HOSTNAME || 'localhost'}`,
]);
...
export const FEEDBACK_URL = process.env.APP_FEEDBACK_URL || '';
export const FAQ_URL = process.env.APP_FAQ_URL || '';
export const PRIVACY_URL = process.env.APP_PRIVACY_URL || '';
export const MINI_APP_TOS_URL = process.env.APP_MINI_APP_TOS_URL || '';
export const FRAGMENT_ADS_URL = '';
