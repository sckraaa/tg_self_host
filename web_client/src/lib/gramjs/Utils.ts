import type { ApiServerConfig } from '../../api/types';
import type { Entity } from './types';

import { resolveDcAddress } from '../../util/mtprotoServer';
import { Api } from './tl';
...
let currentServerConfig: ApiServerConfig | undefined;

export function setServerConfig(serverConfig?: ApiServerConfig) {
...
export function getDC(dcId: number, downloadDC = false) {
  return resolveDcAddress(currentServerConfig, dcId, downloadDC);
