...
export async function doAuthentication(sender: MTProtoPlainSender, log: any) {
  ...
  console.log('[CLIENT DEBUG] serverNonce bytes:', toSignedLittleBuffer(resPQ.serverNonce, 16).toString('hex'));
  // eslint-disable-next-line no-console
  console.log('[CLIENT DEBUG] newNonce bytes:', toSignedLittleBuffer(newNonce, 32).toString('hex'));
  // eslint-disable-next-line no-console
  console.log('[CLIENT DEBUG] key:', key.toString('hex'));
  // eslint-disable-next-line no-console
  console.log('[CLIENT DEBUG] iv:', iv.toString('hex'));
