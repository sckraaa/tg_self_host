...
async function download(
  ...
  if (!entity) {
    ...
    console.warn(`[DLMEDIA] entity NOT in localDb: type=${entityType} id=${entityId}`);
    return undefined;
  }

  // eslint-disable-next-line no-console
  console.debug(`[DLMEDIA] entity found: type=${entityType} id=${entityId} sizeType=${sizeType}`);
