...
const CustomEmojiPicker: FC<OwnProps & StateProps> = ({
  ...
  const isLoading_debug = !shouldRenderContent && !noPopulatedSets;
  console.log('[DEBUG-PICKER] state:', { areAddedLoaded, canRenderContent, noPopulatedSets, shouldRenderContent, isLoading: isLoading_debug, allSetsCount: allSets.length, setsWithStickers: allSets.filter((s) => s.stickers?.length).length, addedCustomEmojiIds: addedCustomEmojiIds?.length, customEmojiFeaturedIds: customEmojiFeaturedIds?.length });
