        ...
        if (currentDatacenter->isCdnDatacenter) {
            ...
            if (serverPublicKeys.empty()) {
                if (ConnectionsManager::getInstance(currentDatacenter->instanceNum).testBackend) {
                    ...
                    serverPublicKeys.emplace_back("-----BEGIN RSA PUBLIC KEY-----\n"
                                                  "MIIBCgKCAQEAucSRRk3kp2bB5BXTuoBrxWTCm1dfdLjtzc0WdMgG42kDGPa7Mrn9\n"
                                                  "k2sZQZz5PSgKQMRUN2NCT69l8nMjMbeyc0wpyzdP7eS4kcVW0joDY02Lmdl1T66A\n"
                                                  "esosCqSctmd+yvXY2J2XgnEbByrtQXp7TPriBHeMxgcn5uHn2wHbATkAp4CunspN\n"
                                                  "GfZCbMIQTfM1qYMAwB1O6x31d0CxlaMAwWyQczOwDRE8xU9ozFAH3+e5dH+F0wsJ\n"
                                                  "V0dhv10DwM5McPLd6vAN/8vE2LdtlZo8fZ7q5B/k8G/ZHVFkhBWwWUsa6cjjpzYK\n"
                                                  "kq1uI/6cJKS3CpPb1itu2ag5iGvokpSLuQIDAQAB\n"
                                                  "-----END RSA PUBLIC KEY-----");
                    serverPublicKeysFingerprints.push_back(0xc6362574e387d217);
                }
            }
